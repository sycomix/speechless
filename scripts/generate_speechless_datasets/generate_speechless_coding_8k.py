...
def prepare_data(model_name_or_path, model_max_len, model_min_len):
    ...
    dataset_file = "/opt/local/datasets/speechless_data/speechless-coding-8k.jsonl"
    ...
    dataset = datasets.concatenate_datasets([
        airoboros_dataset, orca_dataset, platypus_dataset, wizardlm_dataset, tokenbender_dataset, openhermes_dataset, collective_cognition_dataset
    ])
