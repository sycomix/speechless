...
def prepare_data(model_name_or_path, model_max_len, model_min_len):
    ...
    dataset_file = "/opt/local/datasets/speechless_data/speechless-code-math-dataset.jsonl"
    ...
    collective_cognition_dataset = load_collective_cognition_dataset(
        "/opt/local/datasets/base/CollectiveCognition/chats_data2023-10-16.json"
    )

    magicoder_dataset = load_magicoder_dataset(
        "/opt/local/datasets/base/Magicoder/data-oss_instruct-decontaminated.jsonl"
    )
