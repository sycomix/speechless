...
def load_magicoder_dataset(train_data_path: str):
...
def prepare_data(model_name_or_path, model_max_len, model_min_len):
    ...
    dataset_file = "/opt/local/datasets/speechless_data/speechless-code-dataset.jsonl"
    ...
    # magicoder_dataset = load_magicoder_dataset("/opt/local/datasets/base/Magicoder/data-oss_instruct-decontaminated.jsonl")
    ...
    #     airoboros_dataset, orca_dataset, platypus_dataset, wizardlm_dataset, tokenbender_dataset, openhermes_dataset,
    #     collective_cognition_dataset, magicoder_dataset, metamath_dataset
    # ])
    dataset = datasets.concatenate_datasets([
       tinycodes_dataset 
    ])
